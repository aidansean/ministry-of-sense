...
function start(){
  ...
  canvas_eventDisplay_hidden.width  = cw ;
  canvas_eventDisplay_hidden.height = ch ;
  ...
  canvas_eventDisplay_hidden_activity.width  = cw ;
  canvas_eventDisplay_hidden_activity.height = ch ;
